...
cedula_label= Label(text="Cedula:")
cedula_entry = Entry(bd=5, show='*', highlightcolor="red", highlightthickness=2)
...
cedula_label.grid(row=3, column=0, sticky= "w", padx=10, pady=10)
cedula_entry.grid(row=3, column=1, sticky= "w", padx=10, pady=10)
