...
reloj = Label(textvariable= variable_control, fg="blue", font=("Arial", 25), padx=27, pady=27)
boton_start = Button(text="Start", padx=20,  fg="white", bg="green", command=start)
boton_stop = Button(text="Stop", padx=20, fg="white", bg="red", command=stop)

reloj.pack()
boton_start.pack(side="left", padx=50, pady=50)
boton_stop.pack(side="right", padx=50, pady=50)
